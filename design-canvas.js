...
function DCArtboardFrame({
  ...
  }, "Download HTML"), React.createElement("hr", null), React.createElement("button", {
    className: "dc-danger",
    onClick: () => {
      if (confirming) {
        setMenuOpen(false);
  ...
  }, confirming ? 'Click again to delete' : 'Delete'))), React.createElement("button", {
    className: "dc-expand",
    onClick: onFocus,
    title: "Focus"
  }, React.createElement("svg", {
...
function DCFocusOverlay({
  ...
  }, sectionOrder.filter(sid => sectionMeta[sid].slotIds.length).map(sid => React.createElement("button", {
    key: sid,
    onClick: () => {
      setDd(false);
